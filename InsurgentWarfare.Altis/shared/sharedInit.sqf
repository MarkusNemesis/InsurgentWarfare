...
call compileFinal preprocessFileLineNumbers "shared\sharedConstants.sqf";

// Init shared functions
call compileFinal preprocessFileLineNumbers "shared\functions\sharedInitFunctions.sqf";
